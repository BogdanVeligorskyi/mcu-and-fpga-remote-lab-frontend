...
function DigitalInputsGen() {
    ...
    return(
        <div>
            ...
            <input type="number" className="digital-input-duty-value" min="1" max="99" defaultValue="50"/>
            Duty, %
            <input type="number" className="digital-input-frequency-value" min="1" max="30" defaultValue="10"/>
            Freq, kHz
        </div>
    );
}
