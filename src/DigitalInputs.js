...
                    <label htmlFor="buttonCh4"></label>
                ...
                <tr>
                  <td>Switch</td>
                  <td>&nbsp;&nbsp;
                    <input type="radio" id="switchCh1" name="di_pin_1" value="switch"
                    checked={di_pin_1 === "switch"}
                    onChange={onPin1ModeChange}/>
                    <label htmlFor="switchCh1"></label>
                  </td>
                  <td>&nbsp;&nbsp;
                    <input type="radio" id="switchCh2" name="di_pin_2" value="switch"
                    checked={di_pin_2 === "switch"}
                    onChange={onPin2ModeChange}/>
                    <label htmlFor="switchCh2"></label>
                  </td>
                  <td>&nbsp;&nbsp;
                    <input type="radio" id="switchCh3" name="di_pin_3" value="switch"
                    checked={di_pin_3 === "switch"}
                    onChange={onPin3ModeChange}/>
                    <label htmlFor="switchCh3"></label>
                  </td>
                  <td>&nbsp;&nbsp;
                    <input type="radio" id="switchCh4" name="di_pin_4" value="switch"
...
                    <label htmlFor="switchCh4"></label>
                ...
                <tr>
                  <td>Gen</td>
                  <td>&nbsp;&nbsp;
                    <input type="radio" id="genCh1" name="di_pin_1" value="gen"
                    checked={di_pin_1 === "gen"}
                    onChange={onPin1ModeChange}/>
                    <label htmlFor="genCh1"></label>
                  </td>
                  <td>&nbsp;&nbsp;
                    <input type="radio" id="genCh2" name="di_pin_2" value="gen"
                    checked={di_pin_2 === "gen"}
                    onChange={onPin2ModeChange}/>
                    <label htmlFor="genCh2"></label>
                  </td>
                  <td>&nbsp;&nbsp;
                    <input type="radio" id="genCh3" name="di_pin_3" value="gen"
                    checked={di_pin_3 === "gen"}
                    onChange={onPin3ModeChange}/>
                    <label htmlFor="genCh3"></label>
                  </td>
                  <td>&nbsp;&nbsp;
                    <input type="radio" id="genCh4" name="di_pin_4" value="gen"
...
                    <label htmlFor="genCh4"></label>
                ...
                <tr>
                  <td>None</td>
                  <td>&nbsp;&nbsp;
                    <input type="radio" id="noneCh1" name="di_pin_1" value="none"
                    checked={di_pin_1 === "none"}
                    onChange={onPin1ModeChange}/>
                    <label htmlFor="noneCh1"></label>
                  </td>
                    <td>&nbsp;&nbsp;
                    <input type="radio" id="noneCh2" name="di_pin_2" value="none"
                    checked={di_pin_2 === "none"}
                    onChange={onPin2ModeChange}/>
                    <label htmlFor="noneCh2"></label>
                  </td>
                  <td>&nbsp;&nbsp;
                    <input type="radio" id="noneCh3" name="di_pin_3" value="none"
                    checked={di_pin_3 === "none"}
                    onChange={onPin3ModeChange}/>
                    <label htmlFor="noneCh3"></label>
                  </td>
                  <td>&nbsp;&nbsp;
                    <input type="radio" id="noneCh4" name="di_pin_4" value="none"
