...
function DigitalInputs({tokenId}) {
  ...
  const renderPinMode = (pinType, pin) => {
    if (pinType === "button") {
      return <DigitalInputsButton pinNum={pin} renderResult={renderResultBlock} tokenId={tokenId}/>
    }
    if (pinType === "switch") {
      return <DigitalInputsSwitch pinNum={pin} renderResult={renderResultBlock} tokenId={tokenId}/>
    } 
    if (pinType === "gen") {
      return <DigitalInputsGen pinNum={pin} renderResult={renderResultBlock} tokenId={tokenId}/>
    }
  }

  const renderResultBlock = (isRequestCompleted, status, diValue) => {
    //console.log(status);
    if (isRequestCompleted && status === 200) {
      return <div className="digital-inputs-success">{diValue}</div>
    } else if (isRequestCompleted && status !== 200) {
      return <div className="digital-inputs-failure">{diValue}</div>
    } else if (!isRequestCompleted && status === 0) {
      return <div className="digital-inputs-process">{diValue}</div>
    }
  }
          ...
          <tr>
            ...
            <td>&nbsp;&nbsp;
              <input className="digital-input-radio-button" 
                     type="radio" id="buttonCh1" name="di_pin_1" value="button" 
...
              <label htmlFor="buttonCh1"></label>
            ...
            <td>&nbsp;&nbsp;
              <input className="digital-input-radio-button" 
                     type="radio" id="buttonCh2" name="di_pin_2" value="button"
...
              <label htmlFor="buttonCh2"></label>
            ...
            <td>&nbsp;&nbsp;
              <input className="digital-input-radio-button" 
                     type="radio" id="buttonCh3" name="di_pin_3" value="button"
...
              <label htmlFor="buttonCh4"></label>
          ...
          <tr>
            ...
            <td>&nbsp;&nbsp;
              <input className="digital-input-radio-button" 
                     type="radio" id="switchCh1" name="di_pin_1" value="switch"
...
              <label htmlFor="switchCh1"></label>
            ...
            <td>&nbsp;&nbsp;
              <input className="digital-input-radio-button" 
                     type="radio" id="switchCh2" name="di_pin_2" value="switch"
...
              <label htmlFor="switchCh2"></label>
            ...
            <td>&nbsp;&nbsp;
              <input className="digital-input-radio-button" 
                     type="radio" id="switchCh3" name="di_pin_3" value="switch"
...
              <label htmlFor="switchCh4"></label>
          ...
          <tr>
            ...
            <td>&nbsp;&nbsp;
              <input className="digital-input-radio-button" 
                     type="radio" id="genCh1" name="di_pin_1" value="gen"
...
              <label htmlFor="genCh1"></label>
            ...
            <td>&nbsp;&nbsp;
              <input className="digital-input-radio-button" 
                     type="radio" id="genCh2" name="di_pin_2" value="gen"
...
              <label htmlFor="genCh2"></label>
            ...
            <td>&nbsp;&nbsp;
              <input className="digital-input-radio-button" 
                     type="radio" id="genCh3" name="di_pin_3" value="gen"
...
              <label htmlFor="genCh4"></label>
          ...
          <tr>
            ...
            <td>&nbsp;&nbsp;
              <input className="digital-input-radio-button" 
                     type="radio" id="noneCh1" name="di_pin_1" value="none"
...
              <label htmlFor="noneCh1"></label>
            ...
            <td>&nbsp;&nbsp;
              <input className="digital-input-radio-button" 
                     type="radio" id="noneCh2" name="di_pin_2" value="none"
...
              <label htmlFor="noneCh2"></label>
            ...
            <td>&nbsp;&nbsp;
              <input className="digital-input-radio-button" 
                     type="radio" id="noneCh3" name="di_pin_3" value="none"
